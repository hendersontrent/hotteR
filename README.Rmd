...
As well as data scraping and analysis functions, `hotteR` also provides a distinct and eye-catching colour palette that is called and used by default when the package is loaded.
...
More functions are currently under development - with a few specifically related to the Hottest 100 Countdown. Please check back soon!
